// api/condlo.js — Condicionantes da LO
// Rotas:
...
// Rota pública no middleware; cada ação valida sessão OU token, como api/renew_document.js.
const { Redis } = require('@upstash/redis');
const crypto = require('crypto');
const { getSession } = require('../lib/session');
const { checkCondLo, nextDate, STORE_KEY } = require('../lib/condlo');
